...
if($_POST){
    ...
    SET imagen=:imagen, titulo=:titulo, descripcion=:descripcion WHERE id=:id");
    ...
    if ($_FILES["imagen"]["tmp_name"] != "") {
        ...
        if (isset($registro["imagen"]) && file_exists("../../../assets/img/about/" . $registro["imagen"])) {
        ...
        // Actualizar la variable $imagen con el nuevo nombre de archivo
